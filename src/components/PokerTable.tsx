...
export function PokerTable({
  ...
  const renderVerticalPlayer = (player: Player, position: 'top' | 'bottom') => {
    ...
    const canKick = !isCurrentPlayer && onInitiateKick
          ...
          <div className="flex flex-col items-center gap-1 relative">
            {position === 'top' && (
              <>
                ...
                {canKick && (
                  <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    <AnimatedSkull
                      onClick={(e) => {
                        e.stopPropagation()
